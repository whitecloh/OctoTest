...
namespace OctoGames.TestTask.Data
{
    ...
    public sealed class OctoTestSettings : ScriptableObject
    {
        ...
        private const string DefaultUnitDataId = "unit_1";
        ...
        [Header("Units")]
        [SerializeField] private string unitDataId = DefaultUnitDataId;
        [SerializeField] private int defaultUnitInitialValue = 1;
        ...
        public string UnitDataId =>
            string.IsNullOrWhiteSpace(unitDataId) ? DefaultUnitDataId : unitDataId.Trim();

        public int DefaultUnitInitialValue => defaultUnitInitialValue;
