...
namespace OctoGames.TestTask.Gameplay.Units
{
    public sealed class UnitService : IDisposable
    {
        ...
        private readonly UnitsSaveMigrationPipeline _saveMigrationPipeline = new ();
        private readonly UnitMovementPlanner _movementPlanner = new ();
        ...
        public UnitService(OctoTestSettings settings, ISaveLoadService saveLoadService, UnitCatalog unitCatalog)
        {
        ...
        private bool SpawnUnitInternal(bool saveAndNotify)
        {
            ...
            UnitDefinition unitDefinition = _unitCatalog.GetRandom();
            string dataId = unitDefinition.Id;
            int value = unitDefinition.StartValue;
        ...
        public void MoveUnits()
        {
            ...
            _movementPlanner.BuildMovePlan(_units, _grid, _movePlans);
            bool hasMoved = false;
        ...
        {
            Clear();
            _saveMigrationPipeline.MigrateToCurrent(saveData, _unitCatalog);
            UnitSaveMapper.RestoreUnits(saveData, _grid, _settings.MaxUnits, _unitCatalog, _units, ref _nextRuntimeId);
